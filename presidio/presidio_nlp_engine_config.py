...
def create_nlp_engine_with_transformers(model_path):
...
def create_nlp_engine_with_flair(model_path):
    ...
    flair = FlairRecognizer(model_path=model_path)
    registry.add_recognizer(flair)
